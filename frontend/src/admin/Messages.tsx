...
import { Trash2, Phone, Mail, User, Clock, MessageSquareText, RefreshCw, Eye, X, ChevronRight } from 'lucide-react';
    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h2 className="text-3xl font-serif font-bold text-coffee-950 underline decoration-coffee-200 underline-offset-8">All Inquiries</h2>
                    <p className="text-coffee-600 mt-2">Comprehensive view of all customer messages and feedback.</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-coffee-100 shadow-2xl overflow-hidden">
                <div className="p-8 sm:p-10 border-b border-coffee-50 bg-coffee-50/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h3 className="text-2xl font-serif font-bold text-coffee-950">Message Feed</h3>
                        <p className="text-xs text-coffee-500 mt-1 uppercase tracking-widest font-bold">Total entries: {messages.length}</p>
                    </div>
                    <button
            ...
            <div className="flex justify-center pb-10">
                <span className="flex items-center gap-2 text-[10px] font-black text-coffee-300 uppercase tracking-[0.3em]">
                    End of Records
                </span>
            </div>
